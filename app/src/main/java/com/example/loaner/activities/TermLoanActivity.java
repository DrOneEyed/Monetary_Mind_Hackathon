...
import com.example.loaner.databinding.ActivityTermLoanBinding;
import com.example.loaner.utilities.PreferenceManager;
import com.google.firebase.firestore.FirebaseFirestore;

public class TermLoanActivity extends AppCompatActivity {
    private ActivityTermLoanBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityTermLoanBinding.inflate(getLayoutInflater());
    ...
    private void execute(){
        if(valid == true){
            Uri uri = Uri.parse("https://www.bankbazaar.com/personal-loan/term-loan.html");
