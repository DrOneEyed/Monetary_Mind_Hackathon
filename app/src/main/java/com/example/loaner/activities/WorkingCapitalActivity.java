...
import com.example.loaner.databinding.ActivityWorkingCapitalBinding;
...
public class WorkingCapitalActivity extends AppCompatActivity {
    private ActivityWorkingCapitalBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityWorkingCapitalBinding.inflate(getLayoutInflater());
    ...
    private void execute(){
        if(valid == true){
            Uri uri = Uri.parse("https://www.bankbazaar.com/personal-loan/working-capital-loan.html");
