...
import com.example.loaner.databinding.ActivityEducationalLoanBinding;
...
public class EducationalLoanActivity extends AppCompatActivity {
    private ActivityEducationalLoanBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityEducationalLoanBinding.inflate(getLayoutInflater());
    ...
    private void execute(){
        if(valid == true){
            Uri uri = Uri.parse("https://www.bankbazaar.com/education-loan-interest-rate.html");
