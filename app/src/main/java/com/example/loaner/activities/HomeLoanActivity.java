...
public class HomeLoanActivity extends AppCompatActivity {
    private ActivityHomeLoanBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHomeLoanBinding.inflate(getLayoutInflater());
    ...
    private void execute(){
        if(valid == true){
            Uri uri = Uri.parse("https://www.bankbazaar.com/home-loan-interest-rate.html");
