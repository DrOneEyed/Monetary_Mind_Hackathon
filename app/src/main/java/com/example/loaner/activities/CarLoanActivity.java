...
public class CarLoanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCarLoanBinding.inflate(getLayoutInflater());
    ...
    private void execute(){
        if(valid == true){
            Uri uri = Uri.parse("https://www.bankbazaar.com/car-loan.html");
